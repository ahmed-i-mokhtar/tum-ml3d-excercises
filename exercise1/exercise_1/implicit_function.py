...
def signed_distance_atom(x, y, z):
    ...
    # ###############
    # TODO: Implement
    proton = signed_distance_sphere(x, y, z, proton_radius, *proton_center)
    orbit = signed_distance_torus(x, y, z, orbit_radius, orbit_thickness, *proton_center)
    electron = signed_distance_sphere(x, y, z, electron_radius, *electron_center)
    signed_distance = np.minimum(proton, orbit)
    signed_distance = np.minimum(signed_distance, electron)
    return signed_distance
    # ###############
